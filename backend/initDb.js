...
// Settings existentes
db.prepare('INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)').run('entry_fee', '10');
db.prepare('INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)').run('daily_bet_min', '1');
db.prepare('INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)').run('daily_bet_max', '2');

// Settings de mini-pollas — monto de inscripción por fase
